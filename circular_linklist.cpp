...
class CircularLinkedList {
  ...
  // 2. Append a node to the list(insert node at last)
  ...
  // 4. Insert a Node after a particular node in the list(add node at certain postion)
  ...
  // 5. Delete node by unique key(delete node at any place)
...
head address : 0x791930
Circular Linked List Values :
(1,5,0x791560) --> (2,6,0x791580) --> (3,8,0x791930) -->
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. appendNode()
2. prependNode()
3. insertNodeAfter()
...
head address : 0x7959f0
Circular Linked List Values :
(4,7,0x791930) --> (1,5,0x791560) --> (2,6,0x791580) --> (3,8,0x7959f0) -->
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. appendNode()
2. prependNode()
3. insertNodeAfter()
...
head address : 0x7959f0
Circular Linked List Values :
(4,7,0x795a30) --> (5,88,0x791930) --> (1,5,0x791560) --> (2,6,0x791580) --> (3,8,0x7959f0) -->
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. appendNode()
2. prependNode()
3. insertNodeAfter()
...
head address : 0x7959f0
Circular Linked List Values :
(4,7,0x795a30) --> (5,88,0x791560) --> (2,6,0x791580) --> (3,8,0x7959f0) -->
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. appendNode()
2. prependNode()
3. insertNodeAfter()
...
Enter key of the Node to be deleted:
4
Node UNLINKED with keys value : 4
...
head address : 0x795a30
Circular Linked List Values :
(5,88,0x791560) --> (2,6,0x791580) --> (3,8,0x795a30) -->
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. appendNode()
2. prependNode()
3. insertNodeAfter()
...
head address : 0x795a30
Circular Linked List Values :
(5,88,0x791560) --> (2,6,0x791580) --> (3,55,0x795a30) -->
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. appendNode()
2. prependNode()
3. insertNodeAfter()
