...
2
Pop Function Called - Poped Value: 66
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. Push()
2. Pop()
3. isEmpty()
...
2
Pop Function Called - Poped Value: 8
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. Push()
2. Pop()
3. isEmpty()
...
6
Count Function Called - Number of Items in the Stack are: 3
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. Push()
2. Pop()
3. isEmpty()
...
1
Peek Function Called - Value at position 1 is 4
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. Push()
2. Pop()
3. isEmpty()
...
Enter position of item you want to change : 1

Enter value of item you want to change : 88
value changed at location 1
What operation do you want to perform? Select Option number. Enter 0 to exit.
1. Push()
2. Pop()
3. isEmpty()
